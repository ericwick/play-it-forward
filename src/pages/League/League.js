			...
			<div>
				...
				<div className="sortarticles">
					<p className="leaguenewsdiv">
						...
						never had a player who’s had it. But he’s doing better and he was up
						and alert and seemed to be in a good mood.” While the lung could
						keep him out for the immediate future, those with the team are still
						hopeful that Benjamin dodged the worst. <br />
						He did not suffer any broken bones or any other complications around
						the collapsed lung.
					</p>
					...
					<p className="leaguenewsdiv">
						...
						FORT WORTH -- The Eagles have the talent to compete with any team in
						the Big 12. They proved that in nice performances against the No. 5
						Bears, and even against the No. 1 Raiders in a 22-21 loss on two
						weeks ago. <br />
						...
						quarter alone. It could have easily been more if the Eagles started
						the game they way they finished en route to a 56-14 victory.
					</p>

					<p className="leaguenewsdiv">
						<h2 id="articletitle">Bears: Bad at Football, Great at Donating</h2>

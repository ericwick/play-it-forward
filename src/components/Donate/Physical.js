    ...
    return (
        <div className="donate">
            ...
            <p className="inputfield">
                There are a lot of ways to contribute to successful youth
                programs besides opening up your wallet. If you have any extra
                sports equipment of any kind that can be put to use, please send

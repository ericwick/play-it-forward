            ...
            <div className="aboutpage">
                ...
                <div className="aboutpagepicturediv">
                    <p className="aboutplayitforward">
                        Play It Forward is a national, nonprofit organization
                        inspired by the universal desire to become the best
                        verison of yourself. Our members are our power, and your
                        support allows us to work toward a nation where kids of
                        any age are able to participate in any sport they want
                        regardless of their socioeconomic status. Play It
                        Forward wants to afford everyone who is able to Play the
                        opportunity to Play. The registration contributions from
                        the adult leagues help make the kids' leagues possible,
                        but any additional efforts help the leagues thrive and
                        provide an exceptional experience for the children.
                    </p>
                    <img
                        alt=""
